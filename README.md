...
> A continuación se incluye íntegramente el archivo `AURIGA-EN.md` para poder leerse directamente desde este README. Fuente original: [AURIGA-EN.md](https://github.com/mikeround/AURIGA/blob/main/AURIGA-EN.md).
